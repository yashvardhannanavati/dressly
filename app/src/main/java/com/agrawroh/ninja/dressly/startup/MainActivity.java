...
import com.agrawroh.ninja.dressly.fragments.ImageListFragment;
import com.agrawroh.ninja.dressly.login.LoginActivity;
import com.agrawroh.ninja.dressly.miscellaneous.EmptyActivity;
...
import com.agrawroh.ninja.dressly.options.SearchResultActivity;
import com.agrawroh.ninja.dressly.options.WishlistActivity;
import com.agrawroh.ninja.dressly.upload.UploadForm;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_search) {
           ...
           /* NotificationCountSetClass.setAddToCart(this, item, notificationCount);
            invalidateOptionsMenu();*/
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_item1) {
            ...
            LoginActivity.signOut(FirebaseAuth.getInstance().getCurrentUser().getProviderData().get(1).toString());
